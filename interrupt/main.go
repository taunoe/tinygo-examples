...
const (
	button          = machine.D3             // machine.BUTTON
	buttonMode      = machine.PinInputPullup // machine.PinInput  // machine.PinInputPulldown
	buttonPinChange = machine.PinRising      //machine.PinRising      // machine.PinFalling
